...
published: true
name: Videmo
description: An async video messaging platform built to explore the complete lifecycle of video processing—from recording to AI-powered transcription and sharing.
thumbnail: videmo_prev.png
images: [videmo_preview.png]
